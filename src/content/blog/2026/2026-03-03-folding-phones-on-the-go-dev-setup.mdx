...
social_post: |
  After years as an Apple fanboy, I switched to a foldable Android phone. Not for the apps — for the terminal.

  Termux + SSH + Claude Code on a fold-out screen turned my phone into a real dev workstation. Here's the full setup.
---
