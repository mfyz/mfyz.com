...
I recently built [newsletter-digester](https://github.com/mfyz/newsletter-digester), a tool that checks websites/blogs, summarizes posts with AI, and sends digests to Slack. Before writing any code, I spent hours building the initial plan with Claude.
