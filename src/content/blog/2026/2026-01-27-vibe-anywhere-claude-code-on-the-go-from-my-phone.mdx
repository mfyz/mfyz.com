...
social_post: |
  ...
  The solution: SSH to a $6/mo VPS from my iPhone. Terminus + tmux + Claude Code.

  Now I vibe code while picking up kids, in coffee shop lines, and odd places. My phone became a dev machine.
---
