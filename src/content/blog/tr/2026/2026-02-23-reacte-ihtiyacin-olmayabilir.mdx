...
hidden: true
social_post: |
  React her frontend projesi için varsayılan cevap oldu ama çoğu zaman gereksiz. jQuery'den sonra aynı döngüyü tekrarlıyoruz. Blog, landing page, içerik sitesi yapıyorsan vanilla JS, Astro veya htmx yeterli. Basitliği yeniden keşfetmenin zamanı geldi.
---
