...
<ImageZoom src="/images/blog/2025/wordpress-vs-astro-comparison.jpg" alt="Side-by-side comparison of WordPress (left) and Astro (right) versions of mfyz.com" width={1200} height={800} client:load />
