...
<ImageZoom src="/images/blog/2025/wordpress-astro-comparison.jpg" alt="Side-by-side comparison of WordPress and Astro blog posts showing performance improvements" width={1200} height={600} />
...
<table class="performance-table">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>38.9KB</td>
      <td>10.9KB</td>
      <td style="background-color: #e6f4ea; font-weight: bold;">-28.0KB (🔻 72.0%) 😍</td>
    </tr>
    <tr>
      <td>JavaScript Size</td>
      <td>13.4KB</td>
      <td>5.3KB</td>
      <td style="background-color: #e6f4ea; font-weight: bold;">-8.1KB (🔻 60.4%) 😍</td>
    </tr>
    <tr>
      <td>CSS Size</td>
      <td>67.2KB</td>
      <td>6.6KB</td>
      <td style="background-color: #e6f4ea; font-weight: bold;">-60.6KB (🔻 90.2%) 😍</td>
    </tr>
  </tbody>
</table>
