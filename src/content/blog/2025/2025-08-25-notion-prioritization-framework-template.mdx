...
The formula above generates a numeric score that I can then visualize with emoji boxes with different colors. This helps my eyes quickly scan and get a feel about things when I scroll around and read tasks in different projects.
...
You can clone and use this Notion template for your own projects and tasks. I've included all the formulas, database structures, and views that make this system work.
