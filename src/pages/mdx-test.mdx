...
This page demonstrates the custom styling of all markdown elements using our components. Each element has been styled to match our site's design system, with proper typography, spacing, and color schemes for both light and dark modes.

## Typography Elements

Paragraphs like this one use proper text styling with balanced line height and spacing. You can include **bold text** for emphasis or _italic text_ for distinction. You can also use **_bold and italic_** together when needed.
...
3. Third ordered item with _italic text_
